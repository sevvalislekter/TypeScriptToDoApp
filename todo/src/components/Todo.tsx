...
function Todo({ todoProps }: TodoProps) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', border: '1px solid lightgrey', padding: '10px ', marginTop: '25px', borderRadius: '5px' }}>
